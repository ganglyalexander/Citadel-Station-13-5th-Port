...
var/list/admin_verbs_admin = list(
	...
	/datum/adminticket/proc/listtickets,	/datum/admins/proc/show_player_panel,	/*shows an interface for individual players, with various links (links require additional flags*/
